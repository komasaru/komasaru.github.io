...
- [mk-mode SITE : DB - 紫外線観測（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/shigaisen "mk-mode SITE : DB - 紫外線観測（気象庁防災情報XML）")
...
![JMAXML_SHIGAISEN]({{site.baseurl}}/images/2014/06/06/JMAXML_SHIGAISEN.png "JMAXML_SHIGAISEN")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 紫外線観測（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_shigaisen "mk-mode SITE : 一覧 - 紫外線観測（気象庁防災情報XML）")
