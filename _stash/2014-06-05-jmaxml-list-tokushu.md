...
- [mk-mode SITE : DB - 特殊気象報（各種現象）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tokushu_etc "mk-mode SITE : DB - 特殊気象報（各種現象）（気象庁防災情報XML）")
- [mk-mode SITE : DB - 特殊気象報（風）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tokushu_kaze "mk-mode SITE : DB - 特殊気象報（風）（気象庁防災情報XML）")
- [mk-mode SITE : DB - 特殊気象報（気圧）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tokushu_kiatsu "mk-mode SITE : DB - 特殊気象報（気圧）（気象庁防災情報XML）")
...
以下のようなページを作成・公開した。  
観測項目には、「黄砂」、「風じん」、「竜巻」、「ひょう」、「なだれ」、「不連続線の通過」があるが、３項目ずつ分割し選択表示するようにしている。

![JMAXML_TOKUSHU_ETC]({{site.baseurl}}/images/2014/06/05/JMAXML_TOKUSHU_ETC.png "JMAXML_TOKUSHU_ETC")

マウスオーバで簡易な Tips をポップアップするようにしている。（UA, ブラウザによっては表示されないかも）

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 特殊気象報（各種現象）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tokushu_etc "mk-mode SITE : 一覧 - 特殊気象報（各種現象）（気象庁防災情報XML）")
...
![JMAXML_TOKUSHU_KAZE]({{site.baseurl}}/images/2014/06/05/JMAXML_TOKUSHU_KAZE.png "JMAXML_TOKUSHU_KAZE")

マウスオーバで簡易な Tips をポップアップするようにしている。（UA, ブラウザによっては表示されないかも）

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 特殊気象報（風）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tokushu_kaze "mk-mode SITE : 一覧 - 特殊気象報（風）（気象庁防災情報XML）")
...
![JMAXML_TOKUSHU_KIATSU]({{site.baseurl}}/images/2014/06/05/JMAXML_TOKUSHU_KIATSU.png "JMAXML_TOKUSHU_KIATSU")

マウスオーバで簡易な Tips をポップアップするようにしている。（UA, ブラウザによっては表示されないかも）

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 特殊気象報（気圧）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tokushu_kiatsu "mk-mode SITE : 一覧 - 特殊気象報（気圧）（気象庁防災情報XML）")
