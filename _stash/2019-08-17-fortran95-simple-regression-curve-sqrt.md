...
File: `regression_curve_sqrt.f95`
...
* [Gist - Fortran 95 source code to calculate a simple regression curve.(sqrt)](https://gist.github.com/komasaru/d5dd7a7f6d09e8dc1d4b2d98f6832887 "Fortran 95 source code to calculate a simple regression curve.(sqrt)")

### 4. ソースコードのコンパイル

``` text
$ gfortran -o regression_curve_sqrt regression_curve_sqrt.f95
```
...
![REGRESSION_CURVE_SQRT]({{site.baseurl}}/images/2019/08/17/REGRESSION_CURVE_SQRT.png "REGRESSION_CURVE_SQRT")
