...
- [mk-mode SITE : DB - 津波警報・注意報・予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tsunami_keiho "mk-mode SITE : DB - 津波警報・注意報・予報（気象庁防災情報XML）")
- [mk-mode SITE : DB - 津波情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tsunami "mk-mode SITE : DB - 津波情報（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「津波警報・注意報・予報」、「津波情報」を一覧で確認できるようなページを作成したので紹介します。

<!--more-->

### 1. 「一覧 - 津波警報・注意報・予報」ページ

以下のようなページを作成・公開した。

![JMAXML_TSUNAMI_KEIHO]({{site.baseurl}}/images/2014/05/28/JMAXML_TSUNAMI_KEIHO.png "JMAXML_TSUNAMI_KEIHO")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 津波警報・注意報・予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tsunami_keiho "mk-mode SITE : 一覧 - 津波警報・注意報・予報（気象庁防災情報XML）")
...
![JMAXML_TSUNAMI]({{site.baseurl}}/images/2014/05/28/JMAXML_TSUNAMI.png "JMAXML_TSUNAMI")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 津波情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tsunami "mk-mode SITE : 一覧 - 津波情報（気象庁防災情報XML）")
