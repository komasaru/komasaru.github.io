...
- [mk-mode SITE : DB - 潮位情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/choi "mk-mode SITE : DB - 潮位情報（気象庁防災情報XML）")
- [mk-mode SITE : DB - 海氷予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/kaihyo "mk-mode SITE : DB - 海氷予報（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「潮位情報」、「海氷予報」を一覧で確認できるようなページを作成したので紹介します。
...
![JMAXML_CHOI]({{site.baseurl}}/images/2014/05/22/JMAXML_CHOI.png "JMAXML_CHOI")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 潮位情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_choi "mk-mode SITE : 一覧 - 潮位情報（気象庁防災情報XML）")
...
![JMAXML_KAIHYO]({{site.baseurl}}/images/2014/05/22/JMAXML_KAIHYO.png "JMAXML_KAIHYO")

実際のサイトは以下。よろしければ、ご参照ください。（今の季節は、情報の発表はないが。。。）

- [mk-mode SITE : 一覧 - 海氷予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_kaihyo "mk-mode SITE : 一覧 - 海氷予報（気象庁防災情報XML）")

（また、気象庁防災情報 XML の受信状況によっては正しく表示されないことがあるかも知れない）
