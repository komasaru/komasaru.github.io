...
Debian GNU/Linux 9 (Stretch) をサーバ用途・最小構成でインストールする方法についての記録です。
...
* [http://ftp.jaist.ac.jp/pub/Linux/debian-cd/](http://ftp.jaist.ac.jp/pub/Linux/debian-cd/ "http://ftp.jaist.ac.jp/pub/Linux/debian-cd/")
