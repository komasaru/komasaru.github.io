...
- [mk-mode SITE : DB - 天候情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tenko "mk-mode SITE : DB - 天候情報（気象庁防災情報XML）")
- [mk-mode SITE : DB - 季節予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/yoho_kisetsu "mk-mode SITE : DB - 季節予報（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「天候情報」、「季節予報」を一覧で確認できるようなページを作成したので紹介します。
...
![JMAXML_TENKO]({{site.baseurl}}/images/2014/05/24/JMAXML_TENKO.png "JMAXML_TENKO")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 天候情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tenko "mk-mode SITE : 一覧 - 天候情報（気象庁防災情報XML）")
...
![JMAXML_YOHO_KISETSU]({{site.baseurl}}/images/2014/05/24/JMAXML_YOHO_KISETSU.png "JMAXML_YOHO_KISETSU")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 季節予報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_yoho_kisetsu "mk-mode SITE : 一覧 - 季節予報（気象庁防災情報XML）")
