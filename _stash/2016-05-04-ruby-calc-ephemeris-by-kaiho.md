...
海上保安庁・海洋情報部から「[コンピュータによる天体の位置計算式](http://www1.kaiho.mlit.go.jp/KOHO/ "天文・暦情報")」という標題で、計算方法や計算に必要な係数が公開さいれています。

今回は、この方法を Ruby で実装して太陽や月の視赤経や視黄経等を計算してみました。（任意の日時（日本標準時）をコマンドライン引数で指定して実行すると、各種値を計算しコンソール出力する）
...
「[コンピュータによる天体の位置計算式](http://www1.kaiho.mlit.go.jp/KOHO/ "天文・暦情報")」のページにある「[平成28年版・解説と計算例](http://www1.kaiho.mlit.go.jp/KOHO/syoshi/furoku/na16-rei.pdf "天文・暦情報：平成28年版・解説と計算例")」のとおりなので、そちらを参照のこと。

平成20年(2008年)版から資料と係数が公開されています。（Web ページ上は今年・前年分しか存在しないが、 URL の「年」部分を直接編集してアクセスすると取得できる）
...
* [GitHub - komasaru/Calendar/eph_sun_moon.rb](https://github.com/komasaru/Calendar/blob/master/eph_sun_moon.rb "GitHub - komasaru/Calendar/eph_sun_moon.rb")
...
``` text
$ ./eph_sun_moon.rb 20160504152437
[ JST: 2016-05-04 15:24:37,  UTC: 2016-05-04 06:24:37 ]
  SUN  R.A. =   2.78410892 h   (= 02 h 47 m 02.792 s)
  SUN  DEC. =  16.10315728 °   (= 16 ° 06 ′ 11.366 ″)
  SUN DIST. =   1.00845071 AU
  SUN   hG. =  18.46439658 h   (= 18 h 27 m 51.828 s)
  SUN  S.D. =  15.88575406 ′   (= 00 ° 15 ′ 53.145 ″)
  MOON R.A. =   0.54368910 h   (= 00 h 32 m 37.281 s)
  MOON DEC. =   1.82032239 °   (= 01 ° 49 ′ 13.161 ″)
  MOON H.P. =   1.01195708 °   (= 01 ° 00 ′ 43.045 ″)
  MOON  hG. =  20.70481640 h   (= 20 h 42 m 17.339 s)
  MOON S.D. =   0.23315148 ′   (= 00 ° 00 ′ 13.989 ″)
         R  =  14.83822772 h   (= 14 h 50 m 17.620 s)
       EPS. =  23.43461360 °   (= 23 ° 26 ′ 04.609 ″)
```
...
高精度で実用に耐えられそうなので、視赤経・視赤緯を視黄経・視黄緯に変換して二十四節気や旧暦等の計算に応用できそうです。
