...
* [Fortran - 2つの配列から単回帰曲線（自然対数回帰モデル）計算！]({{site.baseurl}}/2019/08/20/fortran95-simple-regression-curve-ln "Fortran - 2つの配列から単回帰曲線（自然対数回帰モデル）計算！")
...
* [Gist - C++ source code to calculate a simple regression curve(ln).](https://gist.github.com/komasaru/57776eeb10290036097aabe3e252c2fd "C++ source code to calculate a simple regression curve(ln).")
...
![REGRESSION_CURVE_LN]({{site.baseurl}}/images/2020/06/02/REGRESSION_CURVE_LN.png "REGRESSION_CURVE_LN")
