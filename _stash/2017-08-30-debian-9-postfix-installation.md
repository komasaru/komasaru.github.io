...
Debian GNU/Linux 9 (Stretch) に SMTP サーバ Postfix を構築する方法についての記録です。
...
mydestination = $myhostname, localhost.$mydomain, localhost, $mydomain, noah.mk-mode.com  # <= 自ドメイン宛メールを受信できるようにする
