...
Debian GNU/Linux 8 (Jessie) に NFS サーバを構築する方法についての記録です。
...
- Debian GNU/Linux 8 (Jessies) での作業を想定。
...
====< 途中省略 >====
         :
vbox.mk-mode.com:/var/exports   23G  396M   22G   2% /var/exports
```
...
ここでは、一旦ファイアウォールを有効化に戻しておく。（この後続けて、次回記事の方法で NFS サーバのポート固定の設定を施すのであれば、この限りでない）
