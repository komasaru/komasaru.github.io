...
* [Python - 連立方程式解法（ガウス・ジョルダン法）！]({{site.baseurl}}/2018/04/07/python-simultaneous-equations-with-gauss-jorden "Python - 連立方程式解法（ガウス・ジョルダン法）！")

### 2. ソースコードの作成

File: `gauss_jordan.f95`

{% highlight fortran linenos %}
!*******************************************************
! Simultaneous equations solving by Gauss-Jorden method
!
!   date          name            version
...
* [Gist - Fortran 95 source code to solve simultaneous equations by Gauss-Jordan's method.](https://gist.github.com/komasaru/7a8d432363410b47915a8cf41d5a25b8 "Gist - Fortran 95 source code to solve simultaneous equations by Gauss-Jordan's method.")

### 3. ソースコードのコンパイル

``` text
$ gfortran -o gauss_jordan gauss_jordan.f95
```
