...
と言っても、「[Ruby - 円周率計算（オイラーの公式(2)）！]({{site.baseurl}}/2013/04/09/ruby-calc-pi-with-eular-2/ "Ruby - 円周率計算（オイラーの公式(2)）！")」のアルゴリズムに追加しただけの形になっていますが。。。  
...
class CalcPiArctan
  ...
  # 多桁計算
  MAX_DIGITS = 100000000  # １つの int で8桁扱う
...
* [Gist - Ruby script to compute Pi with arctan's formula.](https://gist.github.com/komasaru/fcb6c133911c51c849bda97c3b26e3b3 "Gist - Ruby script to compute Pi with arctan's formula.")
