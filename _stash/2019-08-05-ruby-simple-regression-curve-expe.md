...
\frac{\partial S}{\partial a} &=& 2\sum_{i=1}^{N}(\log{a}+bx_{i} - \log{y_i})x_i= 0
\end{eqnarray*}
$$
...
File: `regression_curve_exp_e.rb`
...
* [Gist - Ruby script to calculate a simple regression curve.(exp_e)](https://gist.github.com/komasaru/eb78c3443a862f0bff0f2b7245d46998 "Ruby script to calculate a simple regression curve.(exp_e)")

### 4. Ruby スクリプトの実行

``` text
$ ./regression_curve_exp_e.rb
...
![REGRESSION_CURVE_EXP_E]({{site.baseurl}}/images/2019/08/05/REGRESSION_CURVE_EXP_E.png "REGRESSION_CURVE_EXP_E")
