...
![JMAXML_CNT_TATSUMAKI_C]({{site.baseurl}}/images/2014/06/19/JMAXML_CNT_TATSUMAKI_C.png "JMAXML_CNT_TATSUMAKI_C")
...
- [mk-mode SITE : 集計 - 竜巻注意情報（区市町村別）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_count/cnt_tatsumaki_c "mk-mode SITE : 集計 - 竜巻注意情報（区市町村別）（気象庁防災情報XML）")
...
![JMAXML_CNT_DOSHA_C]({{site.baseurl}}/images/2014/06/19/JMAXML_CNT_DOSHA_C.png "JMAXML_CNT_DOSHA_C")
...
- [mk-mode SITE : 集計 - 土砂災害警戒情報（区市町村別）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_count/cnt_dosha_c "mk-mode SITE : 集計 - 土砂災害警戒情報（区市町村別）（気象庁防災情報XML）")
...
![JMAXML_CNT_KIROKUAME_P]({{site.baseurl}}/images/2014/06/19/JMAXML_CNT_KIROKUAME_P.png "JMAXML_CNT_KIROKUAME_P")
...
- [mk-mode SITE : 集計 - 記録的短時間大雨情報（府県別）（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_count/cnt_kirokuame_p "mk-mode SITE : 集計 - 記録的短時間大雨情報（府県別）（気象庁防災情報XML）")
