...
* [Fortran - 2つの配列から単回帰曲線（e指数回帰モデル）計算！]({{site.baseurl}}/2019/09/02/fortran95-simple-regression-curve-expe "Fortran - 2つの配列から単回帰曲線（e指数回帰モデル）計算！")
...
{% highlight c linenos %}
#ifndef REGRESSION_CURVE_EXP_E_FILE_HPP_
...
{% highlight c linenos %}
#ifndef REGRESSION_CURVE_EXP_E_CALC_HPP_
...
* [Gist - C++ source code to calculate a simple regression curve(exp_e).](https://gist.github.com/komasaru/296430b6a4f41ffa585a28067f5d6108 "C++ source code to calculate a simple regression curve(exp_e).")
...
![REGRESSION_CURVE_EXP_E]({{site.baseurl}}/images/2020/06/22/REGRESSION_CURVE_EXP_E.png "REGRESSION_CURVE_EXP_E")
