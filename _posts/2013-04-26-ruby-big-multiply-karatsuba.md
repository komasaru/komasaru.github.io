...
* [Gist - Ruby script to multiply big-digit values with Karatsuba method.](https://gist.github.com/komasaru/5370005 "Gist - Ruby script to multiply big-digit values with Karatsuba method.")
...
![MULTIPLY_KARATSUBA_RUBY]({{site.baseurl}}/images/2013/04/26/MULTIPLY_KARATSUBA_RUBY.png "MULTIPLY_KARATSUBA_RUBY")

当然ながら、C++ 版の「標準（筆算）法」と「Karatsuba 法」の検証結果グラフと同様なグラフとなった。

![BIG_MULTIPLY_TEST]({{site.baseurl}}/images/2013/04/26/BIG_MULTIPLY_TEST.png "BIG_MULTIPLY_TEST")
