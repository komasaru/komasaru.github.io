...
- [mk-mode SITE : DB - 竜巻注意情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/tatsumaki "mk-mode SITE : DB - 竜巻注意情報（気象庁防災情報XML）")
- [mk-mode SITE : DB - スモッグ気象情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/smog "mk-mode SITE : DB - スモッグ気象情報（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「竜巻注意情報」、「スモッグ気象情報」を一覧で確認できるようなページを作成したので紹介します。
...
![JMAXML_TATSUMAKI]({{site.baseurl}}/images/2014/05/13/JMAXML_TATSUMAKI.png "JMAXML_TATSUMAKI")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 竜巻注意情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_tatsumaki "mk-mode SITE : 一覧 - 竜巻注意情報（気象庁防災情報XML）")
...
![JMAXML_SMOG]({{site.baseurl}}/images/2014/05/13/JMAXML_SMOG.png "JMAXML_SMOG")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - スモッグ気象情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_smog "mk-mode SITE : 一覧 - スモッグ気象情報（気象庁防災情報XML）")
