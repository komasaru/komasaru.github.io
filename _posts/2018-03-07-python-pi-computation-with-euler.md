...
* [Ruby - 円周率計算（オイラーの公式）！]({{site.baseurl}}/2013/04/06/ruby-calc-pi-with-euler "Ruby - 円周率計算（オイラーの公式）！")
...
* [Gist - Python script to compute Pi with Euler's formula.](https://gist.github.com/komasaru/d86b23a7c2e940b84ad9b545612e9b07 "Gist - Python script to compute Pi with Euler's formula.")
...
``` text
$ ./calc_pi_euler.py
** Pi Computation with the Eular formula method **
   Digits = 10000.
   Time   = 21.638310 seconds
```
