...
* NFS サーバ構築済み。  
  （参照：「[Debian 10 (buster) - NFS サーバ構築！]({{site.baseurl}}/2019/11/19/debian-10-nfs-installation/ "Debian 10 (buster) - NFS サーバ構築！")」）
* ファイアウォール ufw(iptables) が構築済み。
  （参照：「[Debian 10 (buster) - ファイアウォール設定！](/2019/10/26/debian-10-firewall-setting/ "Debian 10 (buster) - ファイアウォール設定！")」）
