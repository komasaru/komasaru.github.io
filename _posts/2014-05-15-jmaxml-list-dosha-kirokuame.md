...
- [mk-mode SITE : DB - 土砂災害警戒情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/dosha "mk-mode SITE : DB - 土砂災害警戒情報（気象庁防災情報XML）")
- [mk-mode SITE : DB - 記録的短時間大雨情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/kirokuame "mk-mode SITE : DB - 記録的短時間大雨情報（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「土砂災害警戒情報」、「記録的短時間大雨情報」を一覧で確認できるようなページを作成したので紹介します。
...
![JMAXML_DOSHA]({{site.baseurl}}/images/2014/05/15/JMAXML_DOSHA.png "JMAXML_DOSHA")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 土砂災害警戒情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_dosha "mk-mode SITE : 一覧 - 土砂災害警戒情報（気象庁防災情報XML）")
...
![JMAXML_KIROKUAME]({{site.baseurl}}/images/2014/05/15/JMAXML_KIROKUAME.png "JMAXML_KIROKUAME")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 記録的短時間大雨情報（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_kirokuame "mk-mode SITE : 一覧 - 記録的短時間大雨情報（気象庁防災情報XML）")
...
まだ残っているその他のページについても、今回の処理を流用して順次対応していこうと考えている次第です。
