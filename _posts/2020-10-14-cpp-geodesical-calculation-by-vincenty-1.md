...
* [Gist - C++ source code to calculate geodesical values by Vincenty's formulae.(distance)](https://gist.github.com/komasaru/0255a352e1293f8f0900247586c738aa "Gist - C++ source code to calculate geodesical values by Vincenty's formulae.(distance)")
