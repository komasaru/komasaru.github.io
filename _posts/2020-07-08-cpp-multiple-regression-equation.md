...
{% highlight c linenos %}
#ifndef REGRESSION_MULTI_2E_FILE_HPP_
...
{% highlight c linenos %}
#ifndef REGRESSION_MULTI_2E_CALC_HPP_
...
* [Gist - C++ source code to compute multiple regression equations.](https://gist.github.com/komasaru/c126c6fcacbe93c994cfcd56752d7fa2 "Gist - C++ source code to compute multiple regression equations.")
...
* 「1. アルゴリズム」内の $$b_0, b_1, b_2$$ は、ソースコード内の $$a, b, c$$ に対応。

### 6. 視覚的な確認

参考までに、上記で使用した2変量の各点と作成された単回帰直線を gnuplot で描画してみた。

![REGRESSION_MULTI_2E]({{site.baseurl}}/images/2020/07/08/REGRESSION_MULTI_2E.png "REGRESSION_MULTI_2E")
