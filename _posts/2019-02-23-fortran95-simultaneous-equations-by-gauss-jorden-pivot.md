...
* [Python - 連立方程式解法（ガウス・ジョルダン（ピボット選択）法）！]({{site.baseurl}}/2018/04/10/python-simultaneous-equations-with-gauss-jorden-pivot "Python - 連立方程式解法（ガウス・ジョルダン（ピボット選択）法）！")
...
* [Gist - Fortran 95 source code to solve simultaneous equations by Gauss-Jordan's method(pivot).](https://gist.github.com/komasaru/bdb0877eca9c93e95304a46fb64d102e "Gist - Fortran 95 source code to solve simultaneous equations by Gauss-Jordan's method(pivot).")
