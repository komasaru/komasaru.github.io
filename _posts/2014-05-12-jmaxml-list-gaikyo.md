...
- [mk-mode SITE : DB - 天気概況（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_db/gaikyo "mk-mode SITE : DB - 天気概況（気象庁防災情報XML）")

今までは受信したデータをある程度整形して公開していただけでしたので、若干現状を把握しにくい部分もありました。

前回までの一覧同様、最新の「天気概況」を一覧で確認できるようなページを作成したので紹介します。
...
![JMAXML_GAIKYO]({{site.baseurl}}/images/2014/05/12/JMAXML_GAIKYO.png "JMAXML_GAIKYO")

実際のサイトは以下。よろしければ、ご参照ください。

- [mk-mode SITE : 一覧 - 天気概況（気象庁防災情報XML）](http://www.mk-mode.com/rails/jmaxml_list/lst_gaikyo "mk-mode SITE : 一覧 - 天気概況（気象庁防災情報XML）")
